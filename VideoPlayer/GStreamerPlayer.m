...
static void error_cb (GstBus *bus, GstMessage *msg, GStreamerPlayer *self)
{
    GError *err;
    gchar *debug_info;
...
static void eos_cb (GstBus *bus, GstMessage *msg, GStreamerPlayer *self) {
...
static void buffering_cb (GstBus *bus, GstMessage *msg, GStreamerPlayer *self) {
    gint percent;
...
static void clock_lost_cb (GstBus *bus, GstMessage *msg, GStreamerPlayer *self) {
...
static void check_media_size (GStreamerPlayer *self) {
...
static void state_changed_cb (GstBus *bus, GstMessage *msg, GStreamerPlayer *self)
{
